import TipiTwoCircles from '@/components/TwoCircles/TwoCircles.vue';

// More on how to set up stories at: https://storybook.js.org/docs/vue/writing-stories/introduction
export default {
  title: 'Example/TipiTwoCircles',
  component: TipiTwoCircles,
  tags: ['autodocs'],
...
export const Primary = {
  args: {
    selection: {
      compareswith: { _id: 'ODS 3 Salud y bienestar', initiatives: 2223 },
      selected: { _id: 'ODS 1 Fin de la pobreza', initiatives: 844 },
    },
    styles: {
      topics: {
      ...
      subtopics: {
        '1.1 Erradicar la pobreza extrema': { color: '#eb1c2d', image: 'ods-01.svg' },
        '1.2 Niveles nacionales de pobreza': { color: '#eb1c2d', image: 'ods-01.svg' },
      },
      defaultColor: '#cecece',
